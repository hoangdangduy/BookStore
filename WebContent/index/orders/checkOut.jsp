...
-->
<!DOCTYPE HTML>
<%@page import="entity.orders.Book_Order"%>
   	 		 ...
   	 		 <div class="cont-desc span_1_of_2">
   	 			<%
	   	 			...
	   	 			if (cart != null && cart.getList().size() > 0){
	   	 				ArrayList<Book_Order> listBookOrder = cart.getList();
	   	 				for (int i=0; i<listBookOrder.size(); i++){
	   	 					Book book = listBookOrder.get(i).getBook(); %>		
									<div class="product-details">				
										...
										<div class="desc span_3_of_2">
												...
												<div class="price">
													<p>Giá: <span>$<%=listBookOrder.get(i).getTotalPrice() %></span></p>
												</div>
												<div class="available">
													<ul>
											...
											<div class="share-desc">
												<div class="share">
													...
													<p>Số lượng :</p> <%=listBookOrder.get(i).getQuantity() %>
												</div>
												<div class="button">
													<span>
														<a id="id1" href="../../UpdateCart?method=get&IdBook=<%=book.getId()%>&isEdit=true&isRemove=false">Edit</a>
														<a id="id1" href="../../UpdateCart?method=get&IdBook=<%=book.getId()%>&isEdit=false&isRemove=true">Remove</a>
													</span>
												</div>
												<div class="clear"></div>
											</div>
   	 			...
   	 			%>
	   	 			<div class="product-details">
		   	 			<div class="desc span_3_of_2">
								...
								<div class="button">
									<span>
										<a href="../../CartSaveToFinish">Finish Add To Cart</a>
									</span>
								</div>
								<div class="clear"></div>
							</div>
