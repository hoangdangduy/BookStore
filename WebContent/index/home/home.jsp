			...
			<div class="wrap">
				...
				<div class="account_desc">
					<ul>
						...
						<%}%>
							<li><a href="../person/editInformation.jsp">My account</a></li>
						<%}%>
					</ul>
				</div>
				<div class="clear"></div>
			...
			<div class="header_top">
				...
				<div class="header_top_right">
					...
					<div class="search_box">
						<form action="/BookStore/SearchBook" method="post">
							<input type="text" name="searchBook" value="Search" onfocus="this.value = '';"
					...
					<div class="slider">
						<div class="slider-wrapper theme-default">
							<div id="slider" class="nivoSlider">
								<img src="../../imageBook/1.jpg" data-thumb="images/1.jpg"
									alt="" /> <img src="../../imageBook/2.jpg"
									data-thumb="images/2.jpg" alt="" /> <img
									src="../../imageBook/3.jpg" data-thumb="images/3.jpg" alt="" />
								<img src="../../imageBook/4.jpg" data-thumb="images/4.jpg"
									alt="" />
							</div>
						</div>
					</div>
