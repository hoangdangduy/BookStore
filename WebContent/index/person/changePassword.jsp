				  ...
				  <div class="contact-form">
				  	<h2>Change Password</h2>
					    <form method="post" action="/BookStore/Register">
					    	...
					    	<div>
						    	<span><input name="oldPass" type="text" class="textbox" placeholder="Old Password"></span>
						    </div>
						    <div>
						    	<span><input name="newPass1" type="text" class="textbox" placeholder="New Password"></span>
						    </div>
						    <div>
						    	<span><input name="newPass2" type="text" class="textbox" placeholder="Recover New Password"></span>
						    </div>
